...
use flyaround\coavBundle\Entity\PlanelModel;
...
class PlanelModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planelModels = $em->getRepository('flyaroundcoavBundle:PlanelModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('flyaround\coavBundle\Form\PlanelModelType', $planelModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planelModel);
        $editForm = $this->createForm('flyaround\coavBundle\Form\PlanelModelType', $planelModel);
