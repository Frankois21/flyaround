...
use flyaround\coavBundle\Entity\Flight;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('flyaroundcoavBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('flyaround\coavBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('flyaround\coavBundle\Form\FlightType', $flight);
